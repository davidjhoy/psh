      ...
      return events.map((event) => {
        ...
        if (todayDay == eventDay && event != null) {
          return (
            <EventCard
              key={event._id}
              background={event.flyer}
              groupAVI={event.groupAvi}
              eventName={event.name}
              groupName={event.groupName}
              eventDate={event.startUtc}
              today={today}
  ...
  return (
    <div className={styles.MainWrap}>
      ...
      <div className={styles.ToggleTime}>
        <div
          className={
            timeFrame != "Week" ? styles.TimeButtonSelected : styles.TimeButton
          }
        ...
        <div
          className={
            timeFrame != "Today" ? styles.TimeButtonSelected : styles.TimeButton
          }
      ...
      <div className={styles.EventGrid}>
        {events ? (
          ...
          <Loading
            message={
              geoOn ? "Finding events near you" : "Please turn on geolocation"
            }
          />
        )}
      </div>
